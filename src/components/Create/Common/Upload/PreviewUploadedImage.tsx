...
const PreviewUploadedImage: React.FC<PreviewUploadedImageProps> = ({
    ...
    return (
        <div className="p-2 relative border-2 border-gray-300 border-dashed w-full h-full inherit-border-radius">
            <div className="h-full w-full relative overflow-hidden flex items-center justify-center inherit-border-radius">
                <img src={imageUrl} alt="loading.." className="w-full h-full object-cover inherit-border-radius"/>
            </div>
            <button type="button"
