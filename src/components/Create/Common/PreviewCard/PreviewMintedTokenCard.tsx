...
const PreviewMintedTokenCard: React.FC<PreviewMintedTokenCardProps> = ({
    title,
    url,
    collectionName
}) => {
    return (
            <div className="flex flex-col justify-between overflow-hidden rounded-xl
                            ring-1 ring-blue-300 select-none w-full max-w-[260px]"
            >
                <div>
...
export default PreviewMintedTokenCard;