    ...
    return (
        <div>
            <label className="block text-sm font-bold text-gray-700">
                ...
                {props.type === "file" ? <a className={"hover:underline font-normal text-gray-400"} href={jsonText}
                                            download={"example.json"}>Download traits_example.json</a> : <></>}
            </label>
                        ...
                        {props.type === "file" ? (
                            ...
                            >
                                <g fill="none" id="Page-1" stroke="none">
                                    <g fill="#929292" id="icon-93-inbox-upload">
                                        <path
